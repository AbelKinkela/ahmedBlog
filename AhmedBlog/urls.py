...
urlpatterns = [
    ...
    path('articles/<title>/', articles.views.reading, name='reading'),
    path('about', articles.views.about, name='about'),
    path('book_recomendation', articles.views.book_recomendation,
         name='book_recomendation'),
    path('contact', articles.views.contact, name='contact'),
